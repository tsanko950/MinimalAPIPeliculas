...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class ComentariosEndpoints
    {
        ...
        static async Task<Results<Created<ComentarioDTO>, NotFound>> Crear(int peliculaId, [FromForm] CrearComentarioDTO crearComentarioDTO,
            IRepositorioPeliculas repositorioPeliculas, IRepositorioComentarios repositorioComentarios, IOutputCacheStore outputCacheStore, IMapper mapper)
        {
            ...
            //var pelicula = await repositorioPeliculas.ObtenerPorId(peliculaId);
